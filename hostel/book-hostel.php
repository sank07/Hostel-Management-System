...
$query="insert into  registration(roomno,stayfrom,duration,fees,course,regno,firstName,middleName,lastName,gender,contactno,emailid,egycontactno,guardianName,guardianRelation,guardianContactno,corresAddress,corresCIty,corresState,corresPincode,pmntAddress,pmntCity,pmnatetState,pmntPincode) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('isiisissssisississsisssi',$roomno,$stayfrom,$duration,$feespm,$course,$regno,$fname,$mname,$lname,$gender,$contactno,$emailid,$emcntno,$gurname,$gurrelation,$gurcntno,$caddress,$ccity,$cstate,$cpincode,$paddress,$pcity,$pstate,$ppincode);
$stmt->execute();
//updating capacity of rooms
$stmt1 = $mysqli->prepare("update rooms set capacity= capacity-1 where room_no=?;");
$res=$stmt1->bind_param("i",$roomno);
$stmt1->execute();
						...
						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-primary">
									<div class="panel-heading">Hostel Info</div>
									<div class="panel-body">
										<form method="post" action="book-hostel.php" class="form-horizontal">
							<?php
							$uid=$_SESSION['login'];
...
<label class="col-sm-2 control-label">State : </label>
<div class="col-sm-8">
<input type="text" name="pstate" id="pstate"  class="form-control" required="required">
</div>
</div>
