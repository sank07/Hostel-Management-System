...
check_login();
//Delete Students Hostel Record and User Id
if(isset($_GET['del']))
{
	$id=intval($_GET['del']);
...
<a href="manage-students.php?del=<?php echo $row->regno;?>" title="Delete Record" onclick="return confirm('Do you want to delete');"><i class="fa fa-trash"></i></a></td>
										</tr>
									<?php
$cnt=$cnt+1;
									 } ?>
